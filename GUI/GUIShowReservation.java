...
public class GUIShowReservation extends JPanel{
	...
	private VIABus via;
	public GUIShowReservation(VIABus via) 
	{
	   this.via=via;
		createComponents();
	 ...
	 private void addComponentsToPanel()
	   {
		...
		pricePanel.add(textFieldTotalPrice);
		 ...
		 smallPanel.setLayout(new GridLayout(4,2,8,8));
		 ...
		 smallPanel.add(labelAmountOfPassengers);
		 smallPanel.add(textFieldAmountOfPassengers);
